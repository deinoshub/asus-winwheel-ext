...
const AsusResult = (props: AsusResultProps) => {
  ...
  return (
    <Container>
      ...
      <Note>Lưu ý:</Note>
      <Paragraph>
        - ASUS sẽ kiểm tra và liên hệ để gửi quà đến địa chỉ mà khách hàng cung
        cấp trong vòng 7-15 ngày làm việc (không kể ngày lễ, thứ 7 & chủ nhật).
        Vì một số lí do khách quan không mong muốn (thiên tai, dịch bệnh,...),
        quà có thể được vận chuyển đến chậm hơn so với dự kiến.
      </Paragraph>
      <Paragraph>
        - Ngày cuối cùng nhận khiếu nại: 15/03/2022. ASUS sẽ không giải quyết
        bất kỳ trường hợp khiếu nại nào liên quan đến chương trình sau thời gian
        này.
      </Paragraph>
      <Paragraph>
        - Quà tặng không có giá trị quy đổi thành tiền mặt hoặc các giá trị khác
        tương đương.
      </Paragraph>
      <br />
